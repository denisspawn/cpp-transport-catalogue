...
PROTOBUF_CONSTEXPR TransportRouter::TransportRouter(
    ::_pbi::ConstantInitialized): _impl_{
    /*decltype(_impl_.rout_set_)*/nullptr
  , /*decltype(_impl_._cached_size_)*/{}} {}
...
const uint32_t TableStruct_transport_5frouter_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::tc_serialize::RouterSettings, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::tc_serialize::RouterSettings, _impl_.bus_wait_time_),
  PROTOBUF_FIELD_OFFSET(::tc_serialize::RouterSettings, _impl_.bus_velocity_),
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::tc_serialize::TransportRouter, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::tc_serialize::TransportRouter, _impl_.rout_set_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::tc_serialize::RouterSettings)},
  { 8, -1, -1, sizeof(::tc_serialize::TransportRouter)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::tc_serialize::_RouterSettings_default_instance_._instance,
  &::tc_serialize::_TransportRouter_default_instance_._instance,
};
...
const char descriptor_table_protodef_transport_5frouter_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "\n\016RouterSettings\022\025\n\rbus_wait_time\030\001 \001(\001\022"
  "\024\n\014bus_velocity\030\002 \001(\001\"A\n\017TransportRouter"
  "\022.\n\010rout_set\030\003 \001(\0132\034.tc_serialize.Router"
  "Settingsb\006proto3"
  ;
...
const ::_pbi::DescriptorTable descriptor_table_transport_5frouter_2eproto = {
    false, false, 176, descriptor_table_protodef_transport_5frouter_2eproto,
    "transport_router.proto",
    &descriptor_table_transport_5frouter_2eproto_once, nullptr, 0, 2,
...
RouterSettings::RouterSettings(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  // @@protoc_insertion_point(arena_constructor:tc_serialize.RouterSettings)
}
RouterSettings::RouterSettings(const RouterSettings& from)
  ...
  // @@protoc_insertion_point(copy_constructor:tc_serialize.RouterSettings)
}
...
RouterSettings::~RouterSettings() {
  // @@protoc_insertion_point(destructor:tc_serialize.RouterSettings)
...
// @@protoc_insertion_point(message_clear_start:tc_serialize.RouterSettings)
...
uint8_t* RouterSettings::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:tc_serialize.RouterSettings)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:tc_serialize.RouterSettings)
  return target;
}

size_t RouterSettings::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:tc_serialize.RouterSettings)
  size_t total_size = 0;
...
void RouterSettings::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:tc_serialize.RouterSettings)
...
// @@protoc_insertion_point(class_specific_copy_from_start:tc_serialize.RouterSettings)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
class TransportRouter::_Internal {
 public:
  static const ::tc_serialize::RouterSettings& rout_set(const TransportRouter* msg);
};

const ::tc_serialize::RouterSettings&
TransportRouter::_Internal::rout_set(const TransportRouter* msg) {
  return *msg->_impl_.rout_set_;
}
TransportRouter::TransportRouter(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                         bool is_message_owned)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor(arena, is_message_owned);
  // @@protoc_insertion_point(arena_constructor:tc_serialize.TransportRouter)
}
TransportRouter::TransportRouter(const TransportRouter& from)
  ...
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  if (from._internal_has_rout_set()) {
    _this->_impl_.rout_set_ = new ::tc_serialize::RouterSettings(*from._impl_.rout_set_);
  }
  // @@protoc_insertion_point(copy_constructor:tc_serialize.TransportRouter)
}
...
TransportRouter::~TransportRouter() {
  // @@protoc_insertion_point(destructor:tc_serialize.TransportRouter)
  if (auto *arena = _internal_metadata_.DeleteReturnArena<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>()) {
  (void)arena;
    return;
  }
...
inline void TransportRouter::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
  if (this != internal_default_instance()) delete _impl_.rout_set_;
}
...
// @@protoc_insertion_point(message_clear_start:tc_serialize.TransportRouter)
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
    ...
    switch (tag >> 3) {
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 26)) {
          ptr = ctx->ParseMessage(_internal_mutable_rout_set(), ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* TransportRouter::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:tc_serialize.TransportRouter)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;

  // .tc_serialize.RouterSettings rout_set = 3;
  if (this->_internal_has_rout_set()) {
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessage(3, _Internal::rout_set(this),
        _Internal::rout_set(this).GetCachedSize(), target, stream);
  }
  ...
  // @@protoc_insertion_point(serialize_to_array_end:tc_serialize.TransportRouter)
  return target;
}

size_t TransportRouter::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:tc_serialize.TransportRouter)
  size_t total_size = 0;
...
void TransportRouter::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:tc_serialize.TransportRouter)
  GOOGLE_DCHECK_NE(&from, _this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;

  if (from._internal_has_rout_set()) {
    _this->_internal_mutable_rout_set()->::tc_serialize::RouterSettings::MergeFrom(
        from._internal_rout_set());
  }
  _this->_internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
}

void TransportRouter::CopyFrom(const TransportRouter& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:tc_serialize.TransportRouter)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
void TransportRouter::InternalSwap(TransportRouter* other) {
  using std::swap;
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  swap(_impl_.rout_set_, other->_impl_.rout_set_);
}
...
template<> PROTOBUF_NOINLINE ::tc_serialize::RouterSettings*
Arena::CreateMaybeMessage< ::tc_serialize::RouterSettings >(Arena* arena) {
  return Arena::CreateMessageInternal< ::tc_serialize::RouterSettings >(arena);
}
template<> PROTOBUF_NOINLINE ::tc_serialize::TransportRouter*
Arena::CreateMaybeMessage< ::tc_serialize::TransportRouter >(Arena* arena) {
  return Arena::CreateMessageInternal< ::tc_serialize::TransportRouter >(arena);
}
